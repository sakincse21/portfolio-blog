...
export default function ContactMe({
  ...
  return (
    <div className="flex flex-col grow-1 items-center justify-center min-h-screen">
      <div className="mx-auto flex max-w-7xl flex-col justify-between gap-10 lg:flex-row lg:gap-20 py-20 items-center h-full grow-1">
